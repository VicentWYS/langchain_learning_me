...
if __name__ == "__main__":
    ...
    print(calculator.invoke({"operation": "subtract", "a": 10, "b": 5}))
    print(calculator.invoke({"operation": "multiply", "a": 10, "b": 5}))
    print(calculator.invoke({"operation": "divide", "a": 10, "b": 5}))
